 ...
 * @date 2026-01-26
 */
public interface McAiModelMapper
{
    /**
     * 查询AI模型配置
     *
     ...
     * @return AI模型配置
     */
    public McAiModel selectDefaultModelByType(Integer modelType);
     ...
     * @return 结果
     */
    public int disableOtherModels(@org.apache.ibatis.annotations.Param("modelType") Integer modelType, @org.apache.ibatis.annotations.Param("excludeModelId") Long excludeModelId);
     ...
     * @return 启用的模型
     */
    public McAiModel getActiveModelByType(@org.apache.ibatis.annotations.Param("modelType") Integer modelType);
}
