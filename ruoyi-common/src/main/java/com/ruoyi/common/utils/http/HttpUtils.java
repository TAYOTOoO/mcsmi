...
public class HttpUtils
{
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, java.util.Map<String, String> headers, String param)
    {
        PrintWriter out = null;
        BufferedReader in = null;
        StringBuilder result = new StringBuilder();
        try
        {
            ...
            // 设置超时：连接30秒，读取180秒（图片生成可能需要较长时间）
        ...
        catch (IOException e)
        {
            ...
            throw new RuntimeException("网络IO错误: " + e.getMessage(), e);
        }
        ...
        {
            log.error("调用HttpUtils.sendPost Exception, url=" + url, e);
